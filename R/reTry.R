...
#'
#' Tries to call \code{fun}. If the call results in an error, the error is logged and after some time it is tried again.
#'
#' @param fun a function
#' @param ... arguments passed to \code{fun}
#' @param tries number of tries
#' @param intSleep interval in seconds between tries
#' @param errorLogging a function which is called in case of an error with \code{errorLogging(<try-error>, ...)}
#'
#' @export
