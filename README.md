...
```
    ...
    ## INFO [2018-03-08 11:17:06] example.db OK
...
```
    ...
    ##    <chr>        <dbl>   <dbl>    <dbl> <dbl>
    ##  1 Alabama      13.2      236     58.0  21.2
    ##  2 Alaska       10.0      263     48.0  44.5
    ##  3 Arizona       8.10     294     80.0  31.0
    ##  4 Arkansas      8.80     190     50.0  19.5
    ##  5 California    9.00     276     91.0  40.6
    ##  6 Colorado      7.90     204     78.0  38.7
    ##  7 Connecticut   3.30     110     77.0  11.1
    ##  8 Delaware      5.90     238     72.0  15.8
    ##  9 Florida      15.4      335     80.0  31.9
    ## 10 Georgia      17.4      211     60.0  25.8
    ## # ... with 40 more rows
...
```
    ...
    ## ERROR [2018-03-08 11:17:08] Error in rsqlite_send_query(conn@ptr, statement) : 
    ##   no such table: USArrest
    ## 
    ## ERROR [2018-03-08 11:17:09] Error in rsqlite_send_query(conn@ptr, statement) : 
    ##   no such table: USArrest
